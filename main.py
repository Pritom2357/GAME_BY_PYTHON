...
background = load('58c9ba706ff80193268b4fac.jpeg')
chicken = load('corona1.png')
user = load('shoytan sadman.png')
user_x = 160
...
while keep_alive:
    ...
    if c_positions[0] > 500 and user_x < 100:
        print('crash 1 + CORONA KHAISE TORE', user_x)
        score = score - 50

    if c_positions[2] > 500 and user_x > 200:
        print('crash 3 + CORONA KHAISE TORE', user_x)
        score = score - 50

    if c_positions[1] > 500 and user_x > 100 and user_x < 200:
        print('crash 2 + CORONA KHAISE TORE', user_x)
        score = score - 50
